...
import com.rg171.music.service.impl.SongServiceImpl;
...
public class SongController {
    ...
    public class MyPicConfig implements WebMvcConfigurer {
        ...
        public void addResourceHandlers(ResourceHandlerRegistry registry) {
            registry.addResourceHandler("/img/songPic/**").addResourceLocations("classpath:/img/songPic/");
            // 映射歌曲目录
            // registry.addResourceHandler("/song/**").addResourceLocations("classpath:/img/");
        }
    }
