...
import com.rg171.music.service.impl.SingerServiceImpl;
...
public class SingerController {
    ...
    public class MyPicConfig implements WebMvcConfigurer {
        ...
        public void addResourceHandlers(ResourceHandlerRegistry registry) {
            // addResourceHandler：拦截请求地址
            // addResourceLocations：映射地址
            registry.addResourceHandler("classpath:/img/singerPic/**").addResourceLocations("classpath:/img/singerPic/");
        }
    }
